    ...
    while True:
        ...
        if checkIfProcessRunning('Discord'):
            ...
            try:
                ...
                # let's wait max 10 seconds so we give Discord client the time before we shoot our rich presence.
...
def RPCWithoutButtons(rpc_application_id, rpc_title, rpc_desc):
    ...
    """
    ╔═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═╗                        
    ║ ✅ Looking good! RichPresence is UP and shining on your profile! ✅ ║
    ╚═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═─═╝
    """)
